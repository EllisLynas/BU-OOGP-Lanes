...
ControlsScreen::MenuState ControlsScreen::DisplayControlsScreen(sf::RenderWindow& window)
{
	// BACKGROUND IMAGE
	sf::Texture t_Background;
	sf::Sprite s_Background;
	t_Background.loadFromFile("Resources/ControlsMenu.png");
	s_Background.setTexture(t_Background);

	// NEXT BUTTON
	sf::Texture t_btn_Next;
	sf::Sprite s_btn_Next;
	t_btn_Next.loadFromFile("Resources/btn_Next.png");
